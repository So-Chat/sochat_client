...
class Menus {
    ...
    if (chat.type == ChatType.PRIVATE) {
      ...
      return () {
        if (chat.participants.length <= 1 &&
            chat.participants[0].user.id == currentUser!.id) {
      ...
      child: ListView(
        ...
        children: [
          ...chat.participants.map(
            (e) => FriendItem(user: e.user, color: Colors.transparent),
          ),
        ],
      ),
    );
                ...
                SoButton(
                  ...
                  onPressed: () {
                    ref
                        ...
                        .updateServerName(oldKey, nameController.text);
                    ref
                        .watch(keyServiceProvider.notifier)
                        .updateServerIp(oldKey, ipController.text);
              ...
              children: [
                SettingsButton(
                  ...
                  onPressed: () {
                    ref
                        .watch(keyServiceProvider.notifier)
                        .addServer(nameController.text, ipController.text);
              ...
              children: [
                SettingsButton(
                  ...
                  onPressed: () {
                    ref
                        .watch(keyServiceProvider.notifier)
                        .updateProfileName(oldKey, nameController.text);
                    ref.read(contextManagerProvider).hideWindow();
                  },
                ),
                SettingsButton(
  ...
  static VoidCallback createChatDialog(BuildContext context, WidgetRef ref) {
    return () async {
            ...
            Column(
              ...
              children: [
                SoCommonInput(
                  ...
                  decoration: InputDecoration(hintText: "Type chat name"),
                ),
                      ...
                      builder: (context, selected, _) {
                        ...
                        return Padding(
                          ...
                          child: SoButton(
                            ...
                            onPressed: () {
                              if (isSelected) {
                                selectedButtons.value = List.from(selected)
                                  ..remove(index);
                              } else {
                                selectedButtons.value = List.from(selected)
                                  ..add(index);
            ...
            Row(
              ...
              children: [
                SoButton(
                  ...
                  onPressed: () {
                    isNotSecure.value = !isNotSecure.value;
                  },
  ...
  static List<ContextMenuButton> friendContext(
    ...
    FriendshipStatus status =
        friendshipService.friendships[user.username]!.status;
    ...
    if (status == FriendshipStatus.ACCEPTED) {
      ...
      if (ref
        ...
        items.add(
          ContextMenuButton(
            ...
            onTap: () {
              chatService.createChat([user.id], ChatType.PRIVATE, null);
            },
          ),
        );
      }
      ...
      items.add(
        ContextMenuButton(
          ...
          onTap: () {
            friendshipService.blockUser(user.username);
          },
        ),
      );
