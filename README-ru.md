...
## Функции
- Сквозное шифрование — Сообщения и медиа шифруются перед отправкой на сервер
- Пользовательские профили
- Друзья и запросы в друзья
- Приватные и групповые чаты
- Обмен медиа
- P2P голосовые и видео звонки
- Выбор устройств для звонков
- Поддержка десктопных платформ
### Запланировые функции
- Больше шифрования
- Звонки на основе SFU
- Мобильный интерфейс
- Аватары
